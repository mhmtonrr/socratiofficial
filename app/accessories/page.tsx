        ...
        <>
            ...
            <div className="relative h-[300px] w-full overflow-hidden bg-surface-light">
                <div className="absolute inset-0 flex flex-col items-center justify-center text-text-main-light">
                    <h1 className="text-4xl md:text-5xl font-serif font-medium tracking-tight mb-4">Accessories</h1>
            ...
            <div className="max-w-[1440px] mx-auto px-4 sm:px-8 py-12">
                {products.length === 0 ? (
                    <div className="text-center py-20">
                        <p className="text-gray-400 font-serif italic">Our accessory collection will be available soon.</p>
                        ...
                        {products.map((product) => (
                            <Link key={product.id} href={`/product/${product.slug}`} className="group cursor-pointer">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-sm font-light text-gray-500">R {Number(product.basePrice).toLocaleString()}</p>
                                </div>
                            </Link>
                        ))}
                    </div>
